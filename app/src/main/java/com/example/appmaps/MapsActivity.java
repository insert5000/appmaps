...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        casa = new LatLng(-18.0274435, -70.2680161);
        zoom = 16;
    ...
    private void seleccionMapa(int seleccion){
        ...
        switch (seleccion) {
            ...
            case 1:
                ...
                agregarIcono(japon, R.drawable.ww);
                break;
            ...
            case 2:
                ...
                agregarIcono(italia, R.drawable.tt);
                break;
            ...
            case 3:
                ...
                Toast.makeText(getApplicationContext(),"Alemania a "+String
                        .valueOf(kilometro.format(distance))+" KM",Toast.LENGTH_LONG).show();
                agregarIcono(alemania, R.drawable.ss);
                break;
            ...
            case 4:
                ...
                Toast.makeText(getApplicationContext(),"Francia a "+String
                        .valueOf(kilometro.format(distance))+" KM",Toast.LENGTH_LONG).show();
                agregarIcono(francia, R.drawable.pp);
                break;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        GroundOverlayOptions casaOverlay = new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.ubi))
                .position(casa, 100);
        ...
        Spinner tipoM = (Spinner)findViewById(R.id.spnMapas);
